 ...
 */
        ...
        var regex = /\/po-enterprise-nav(\.esm)?\.js($|\?|#)/;
        var scriptElm = currentScript || Array.from(document.querySelectorAll('script')).find(function(s) {
            return regex.test(s.src) || s.getAttribute('data-stencil-namespace') === "po-enterprise-nav";
        });

        var resourcesUrl = scriptElm ? scriptElm.getAttribute('data-resources-url') || scriptElm.src : '';
        //original
        var start = function() {
            var url = new URL('./p-2c5ac4d6.system.js',new URL(resourcesUrl,window.location.origin));
            System.import(url.href);
        };

        // It looks like there is a same origin error going on. Not sure if it's Morpheus or 
        // var start = function() {
        //     var url = new URL('https://lib.lumen.com/EnterpriseNav/4.15.1/dist/po-enterprise-nav/p-2c5ac4d6.system.js');
        //     console.log('here in the start function. What is the new URL? ', url);
        //     System.import(url.href);
        // };
