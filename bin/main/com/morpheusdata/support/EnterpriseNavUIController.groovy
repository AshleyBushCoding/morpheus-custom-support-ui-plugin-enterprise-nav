...
class EnterpriseNavUIController implements PluginController {

	MorpheusContext morpheusContext
	Plugin plugin

	public EnterpriseNavUIController(Plugin plugin, MorpheusContext morpheusContext) {
		this.plugin = plugin
	...
	public String getCode() {
		return 'enterpriseNavUIController'
	}

	@Override
	String getName() {
		return 'Enterprise Nav UI Controller'
	}
...
// getRoutes needs to be implemented--maybe add the enteprise nav routes here when the code is officially ready.
	...
	// I don't think we need any of this for the enterprise nav code...
